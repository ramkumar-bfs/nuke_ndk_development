...
namespace DD {
  namespace Image {
    ...
    mFnDeprecatedInNuke13("PlusSamples(const ChannelMap&, DeepSample, DeepSample) has been deprecated.")
    DDImage_API DeepSample PlusSamples(const ChannelMap& chanMap, DeepSample sampleA, DeepSample sampleB);
    mFnDeprecatedInNuke13("MergeSamples(const ChannelMap&, DeepSample, DeepSample) has been deprecated.")
    ...
    mFnDeprecatedInNuke13("DeoverlapSamples(const ChannelMap&, const DeepPixel&, DeepOutPixel&) has been deprecated.")
    DDImage_API void DeoverlapSamples(const ChannelMap& channels, const DeepPixel& deepPixel, DeepOutPixel& pixels);
    mFnDeprecatedInNuke13("MergeOverlappingSamples(const DD::Image::ChannelSet&, const DeepPixel&, DeepOutPixel&, CombineFunc) has been deprecated.")
