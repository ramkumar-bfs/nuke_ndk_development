...
namespace DD
{
  namespace Image
  {
    ...
    namespace SceneGraph {
      ...
      static const std::vector<std::string> kSerialisedFields{kNameField, kTypeField};
      static const std::map<std::string, std::vector<std::string>> kDefaultFields{{kNameField, {kSceneGraphDefaultNodeList[0]}}, {kTypeField, {kSceneGraphDefaultNodeList[0]}}};;
    }
