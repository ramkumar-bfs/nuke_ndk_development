...
/*!
 * \brief gl_quadi Draws a filled quad (int version).
 * \param x left bottom value along x axis.
 * \param y left bottom value along y axis.
 * \param right right top value along x axis.
 * \param top right top value along y axis.
 */
