    ...
    */
    ...
    public:
      ...
      */
      ...
      /*! Return a stage filled in for this GeomOp's current OutputContext (frame & view)
          by calling buildStage().

          Subclasses can override this to provide a stage from an alternative source.
      */
      virtual usg::StageRef  getStage();

      /*! Same as getOutputStage but retrieves a filled in stage from this node's input
          if it's also a GeomOp, otherwise the stage will be empty.
