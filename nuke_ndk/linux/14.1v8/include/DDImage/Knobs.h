...
namespace DD
{
  namespace Image
  {
    ...
    */
    ...
    DDImage_API Knob* PathExpression_knob(Knob_Callback f, std::string* p, NAME n, LABEL l = nullptr);
    DDImage_API Knob* PathExpression_knob(Knob_Callback f, std::string* p, const std::string& filters, NAME n, LABEL l = nullptr);
    DDImage_API Knob* Input_PathExpression_knob(Knob_Callback f, std::string* p, int input, NAME n, LABEL l = nullptr);
    DDImage_API Knob* Input_PathExpression_knob(Knob_Callback f, std::string* p, int input, const std::string& filters, NAME n, LABEL l = nullptr);

    //! Controls a string containing a prim path
    DDImage_API Knob* Path_knob(Knob_Callback f, std::string* p, NAME n, LABEL l = nullptr);
    DDImage_API Knob* Path_knob(Knob_Callback f, std::string* p, const std::string& filters, NAME n, LABEL l = nullptr);
    DDImage_API Knob* Input_Path_knob(Knob_Callback f, std::string* p, int input, NAME n, LABEL l = nullptr);
    DDImage_API Knob* Input_Path_knob(Knob_Callback f, std::string* p, int input, const std::string& filters, NAME n, LABEL l = nullptr);
