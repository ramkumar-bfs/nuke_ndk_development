...
#define kDDImageVersion "14.1"
#define kDDImageVersionInteger (10000 * 14 + 1000 * 1 + 8)
#define kDDImageVersionMajorNum 14
#define kDDImageVersionMinorNum 1
#define kDDImageVersionReleaseNum 8
#define kDDImageVersionReleaseStr "v8"
#define kDDImageVersionPhase DD::Image::Version::eRelease
#define kDDImageVersionPhaseNum 3
#define kDDImageVersion64Bit true
#define kDDImage_ABI_version DDImage_ABI_14_1_1
