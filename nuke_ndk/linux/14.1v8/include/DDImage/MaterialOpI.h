  ...
  namespace Image
  {
    ...
    */
    ...
    public:
      ...
      /*! Assign an optional override Op used for shader property value updating which may
          have a different time or view than the base Op the MaterialOpI is bound to.
      ...
      */
      ...
      virtual Op*  getOverrideOp() const { return nullptr; }
    ...
    public:
      ...
      */
      ...
      /*! Creates a path representing the op, typically put into a shader 'file' input property.
          ...
          The path includes the node path and instance(clone), OutputContext(frame, view, proxy info,)
          and op hash and follows this syntax:
            /NkRoot/<node-path>:<frame-num>:<view-name>:<proxy-info>:0x<op-hash>.<opclass-ext>
          ...
          so this is why the node path + instance, view, frame, proxy-info and hash are provided to
          uniquely identify a specific Op*.
