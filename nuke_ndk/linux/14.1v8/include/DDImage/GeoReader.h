...
namespace DD
{
  namespace Image
  {
    ...
    {
    protected:
      // Allow access to GeoReder to configure internals:
    ...
    public:
      //------------------------------------------------------------------------
      // Deprecated virtual methods - do not use they are non-functional!
      //------------------------------------------------------------------------
      mFnDeprecatedInNuke14("geometry_engine(Scene&, GeometryList&) has been deprecated, use getScene() instead.")
