...
public:
  static inline const openassetio_abi::trait::TraitId kId = "openassetio-mediacreation:usage.Relationship";

  /**
   * Construct this trait view, wrapping the given TraitsData instance.
   */
  explicit RelationshipTrait(openassetio_abi::TraitsDataPtr traitsData)
