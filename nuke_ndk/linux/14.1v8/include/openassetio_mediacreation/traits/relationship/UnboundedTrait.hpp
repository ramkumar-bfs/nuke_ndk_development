...
public:
  static inline const openassetio_abi::trait::TraitId kId = "openassetio-mediacreation:relationship.Unbounded";

  /**
   * Construct this trait view, wrapping the given TraitsData instance.
   */
  explicit UnboundedTrait(openassetio_abi::TraitsDataPtr traitsData)
