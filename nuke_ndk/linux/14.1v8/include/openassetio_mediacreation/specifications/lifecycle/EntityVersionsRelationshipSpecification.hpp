...
/**
 * A relationship between alternate versions of the same logical entity.
 * This may include unstable versions such as "latest".
 * Usage: relationship
 */
...
public:
   ...
   */
  static EntityVersionsRelationshipSpecification create() {
    return EntityVersionsRelationshipSpecification{
   ...
   * TraitsData instance.
   */
  explicit EntityVersionsRelationshipSpecification(openassetio_abi::TraitsDataPtr traitsData)
