...
#ifndef USG_LUX_LIGHTLISTAPI_H
#define USG_LUX_LIGHTLISTAPI_H
...
namespace lux {
  ...
  class USG_API LightListAPI {
  public:
    LightListAPI();
    LightListAPI(const Prim& prim);
    ~LightListAPI();
    ...
    void setLightList(const PathArray& value);
    PathArray getLightList() const;
