...
#ifndef USG_LUX_CYLINDERLIGHTPRIM_H
#define USG_LUX_CYLINDERLIGHTPRIM_H
...
#include "usg/lux/BoundableLightBasePrim.h"

namespace usg {
namespace lux {

  // class CylinderLightPrim
  //   inherits from BoundableLightBase
  //
  // Attributes:
  //     rel filters
  ...
  //   From BoundableLightBase:

  class USG_API CylinderLightPrim : public BoundableLightBasePrim {
  public:
    CylinderLightPrim();
    CylinderLightPrim(const Prim& prim);
    ~CylinderLightPrim();

    bool validate();
    static bool isValidPrim(const Prim& prim);
    static CylinderLightPrim defineInLayer(const LayerRef& layer, const Path& path);
    static CylinderLightPrim overrideInLayer(const LayerRef& layer, const Prim& prim);
    static CylinderLightPrim getInStage(const StageRef& stage, const Path& path);
    ...
    Attribute createLengthAttr(const Value& defaultValue = Value());
    Attribute getLengthAttr() const;
    void setLength(float value, fdk::TimeValue time = fdk::defaultTimeValue());
    float getLength(fdk::TimeValue time = fdk::defaultTimeValue()) const;
    ...
    void setRadius(float value, fdk::TimeValue time = fdk::defaultTimeValue());
    float getRadius(fdk::TimeValue time = fdk::defaultTimeValue()) const;
    ...
    Attribute createTreatAsLineAttr(const Value& defaultValue = Value());
    Attribute getTreatAsLineAttr() const;
    void setTreatAsLine(bool value, fdk::TimeValue time = fdk::defaultTimeValue());
    bool getTreatAsLine(fdk::TimeValue time = fdk::defaultTimeValue()) const;
