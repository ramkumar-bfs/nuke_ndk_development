...
#ifndef USG_LUX_SPHERELIGHTPRIM_H
#define USG_LUX_SPHERELIGHTPRIM_H
...
namespace lux {
  ...
  class USG_API SphereLightPrim : public BoundableLightBasePrim {
  public:
    SphereLightPrim();
    SphereLightPrim(const Prim& prim);
    ~SphereLightPrim();

    bool validate();
    static bool isValidPrim(const Prim& prim);
    static SphereLightPrim defineInLayer(const LayerRef& layer, const Path& path);
    static SphereLightPrim overrideInLayer(const LayerRef& layer, const Prim& prim);
    static SphereLightPrim getInStage(const StageRef& stage, const Path& path);
    ...
    Attribute createTreatAsPointAttr(const Value& defaultValue = Value());
    Attribute getTreatAsPointAttr() const;
    void setTreatAsPoint(bool value, fdk::TimeValue time = fdk::defaultTimeValue());
    bool getTreatAsPoint(fdk::TimeValue time = fdk::defaultTimeValue()) const;
