...
#define kFnUsdEngineVersion "0.2."
#define kFnUsdEngineVersionInteger (10000 * 0 + 1000 * 2 + 1)
#define kFnUsdEngineVersionMajorNum 0
#define kFnUsdEngineVersionMinorNum 2
#define kFnUsdEngineVersionPatchNum 1
