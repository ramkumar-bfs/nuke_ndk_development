...
#ifndef USG_LUX_DISTANTLIGHTPRIM_H
#define USG_LUX_DISTANTLIGHTPRIM_H
...
namespace lux {
  ...
  class USG_API DistantLightPrim : public NonboundableLightBasePrim {
  public:
    DistantLightPrim();
    ...
    static DistantLightPrim defineInLayer(const LayerRef& layer, const Path& path);
    static DistantLightPrim overrideInLayer(const LayerRef& layer, const Prim& prim);
    static DistantLightPrim getInStage(const StageRef& stage, const Path& path);
