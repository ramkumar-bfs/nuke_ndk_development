...
#ifndef USG_LUX_PORTALLIGHTPRIM_H
#define USG_LUX_PORTALLIGHTPRIM_H
...
namespace lux {
  ...
  class USG_API PortalLightPrim : public BoundableLightBasePrim {
  public:
    PortalLightPrim();
    PortalLightPrim(const Prim& prim);
    ~PortalLightPrim();

    bool validate();
    static bool isValidPrim(const Prim& prim);
    static PortalLightPrim defineInLayer(const LayerRef& layer, const Path& path);
    static PortalLightPrim overrideInLayer(const LayerRef& layer, const Prim& prim);
    static PortalLightPrim getInStage(const StageRef& stage, const Path& path);
    ...
    void setHeight(float value, fdk::TimeValue time = fdk::defaultTimeValue());
    float getHeight(fdk::TimeValue time = fdk::defaultTimeValue()) const;
    ...
    Attribute createWidthAttr(const Value& defaultValue = Value());
    Attribute getWidthAttr() const;
    void setWidth(float value, fdk::TimeValue time = fdk::defaultTimeValue());
    float getWidth(fdk::TimeValue time = fdk::defaultTimeValue()) const;
