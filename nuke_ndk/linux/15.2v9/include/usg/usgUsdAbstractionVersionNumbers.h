...
#define kFnUsdAbstractionVersion "0.5."
#define kFnUsdAbstractionVersionInteger (10000 * 0 + 1000 * 5 + 3)
#define kFnUsdAbstractionVersionMajorNum 0
#define kFnUsdAbstractionVersionMinorNum 5
#define kFnUsdAbstractionVersionPatchNum 3
