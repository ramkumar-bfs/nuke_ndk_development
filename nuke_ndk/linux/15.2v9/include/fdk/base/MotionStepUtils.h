                 ...
                 const Mat4dList&     motion_xforms)
{
  ...
  return lerp(motion_xforms[motion_step], motion_xforms[motion_step+1], motion_step_t);
}
                  ...
                  Mat4d&               xformB)
{
  ...
  else
  {
    ...
    xformA = lerp(motion_xformsA[motion_step], motion_xformsA[motion_step+1], motion_step_t);
  }
  ...
  else
  {
    ...
    xformB = lerp(motion_xformsB[motion_step], motion_xformsB[motion_step+1], motion_step_t);
  }
}
