...
namespace fdk {
  ...
  public:
    ...
    Handle allocateRaw()
    {
      ...
      if (_firstFree != nullhandle) {
        ...
        h = (_currentBlock << BLOCKBITS) | _end;
        ++_end;
      }
  ...
  private:
    ...
    inline bool allocBlock()
    {
      ...
      TYPE* block = nullptr;
      if (_currentBlock + 1 == _blocks.size()) {
  ...
  protected:
    ...
    int _currentBlock = -1; //! The block containing the end of the allocated segment.
