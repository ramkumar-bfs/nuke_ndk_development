...
namespace ndk {
  ...
  struct NDK_API IntersectionContext {
    ...
    usg::PathSet excludePaths;    //< Exclude these prims from intersection testing. Takes precedence over includeType
    usg::TokenSet includeType;    //< Only test against prims of these types
  };
