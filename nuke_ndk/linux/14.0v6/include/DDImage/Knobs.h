  ...
  namespace Image
  {
    ...
    */
    ...
    protected:
      ...
      inline void enableKnobQuerying() { _queryingKnobs = true; }

    public:
      Knob_Closure(bool makeKnobs = false) : _makeKnobs(makeKnobs), _lastMadeKnob(nullptr), _queryingKnobs(false) {}
    ...
    */
    ...
    inline Knob* PathExpression_knob(Knob_Callback f, std::string* p, NAME n, LABEL l = nullptr)
    {
      return f(PATH_EXPRESSION_KNOB, StlStringPtr, p, n, l, nullptr);
    }

    //! Controls a string containing a prim path
    inline Knob* Path_knob(Knob_Callback f, std::string* p, NAME n, LABEL l = nullptr)
    {
      return f(PATH_KNOB, StlStringPtr, p, n, l, nullptr);
    }
