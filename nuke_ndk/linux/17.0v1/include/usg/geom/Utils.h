...
namespace usg {
  ...
  // Returns true if the file at the given path is a supported Ogawa Alembic file.
  USG_API bool IsSupportedAlembicFile(const std::string& path, std::string& message);
