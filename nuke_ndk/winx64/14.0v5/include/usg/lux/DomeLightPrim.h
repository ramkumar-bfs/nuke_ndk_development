...
#ifndef USG_LUX_DOMELIGHTPRIM_H
#define USG_LUX_DOMELIGHTPRIM_H
...
namespace lux {
  ...
  //     token inputs:texture:format = "automatic" (allowed values: automatic, latlong, mirroredBall, angular, cubeMapVerticalCross)
  ...
  class USG_API DomeLightPrim : public NonboundableLightBasePrim {
  public:
    DomeLightPrim();
    DomeLightPrim(const Prim& prim);
    ~DomeLightPrim();

    bool validate();
    static bool isValidPrim(const Prim& prim);
    static DomeLightPrim defineInLayer(const LayerRef& layer, const Path& path);
    static DomeLightPrim overrideInLayer(const LayerRef& layer, const Prim& prim);
    static DomeLightPrim getInStage(const StageRef& stage, const Path& path);
    ...
    Attribute createGuideRadiusAttr(const Value& defaultValue = Value());
    Attribute getGuideRadiusAttr() const;
    void setGuideRadius(float value, fdk::TimeValue time = fdk::defaultTimeValue());
    float getGuideRadius(fdk::TimeValue time = fdk::defaultTimeValue()) const;
    ...
    Attribute createTextureFileAttr(const Value& defaultValue = Value());
    Attribute getTextureFileAttr() const;
    void setTextureFile(const AssetPath& value, fdk::TimeValue time = fdk::defaultTimeValue());
    AssetPath getTextureFile(fdk::TimeValue time = fdk::defaultTimeValue()) const;

    Attribute createTextureFormatAttr(const Value& defaultValue = Value());
    Attribute getTextureFormatAttr() const;
    void setTextureFormat(const Token& value, fdk::TimeValue time = fdk::defaultTimeValue());
    Token getTextureFormat(fdk::TimeValue time = fdk::defaultTimeValue()) const;
    ...
    Relationship createPortalsRel();
    Relationship getPortalsRel() const;
    void setPortals(const PathArray& value, fdk::TimeValue time = fdk::defaultTimeValue());
    PathArray getPortals(fdk::TimeValue time = fdk::defaultTimeValue()) const;
