...
namespace DD {
  namespace Image {
    ...
    public:
      ...
      const usg::Path& path(const Hash& objID) const;
      ...
      */
      ...
      void setPath(const Hash& objID, const usg::Path& path);
...
#endif
      static Hash geoID(const usg::Path& path);
      static Hash geoID(const usg::Prim& geo);
