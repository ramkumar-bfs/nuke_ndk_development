...
#error "Remove the above code block in Nuke 15 as they are deprecated in Nuke 14."
      ...
      */
      ...
      bool isLegacyAxisOp() const { return _isLegacyAxisOp(); }
#else
#error "Remove the above code block in Nuke 15 as they are deprecated in Nuke 14."
#endif
    ...
    public:
      ...
      mFnDeprecatedInNuke14("lookAtEnabled() has been deprecated")
        virtual bool   lookAtEnabled() const { return isLegacyAxisOp(); }
      mFnDeprecatedInNuke14("lookat_input() has been deprecated")
        Op*            lookat_input() const override { return (lookAtEnabled()) ? Op::input(1) : nullptr; }
      //-----------------------------
      ...
      mFnDeprecatedInNuke14("matrixAt() has been deprecated, use getWorldTransformAt() instead.")
