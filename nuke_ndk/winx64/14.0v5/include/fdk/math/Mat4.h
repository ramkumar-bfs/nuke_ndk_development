...
namespace fdk {
  ...
  public:
    ...
    Mat4(T a, T b, T c, T d,
         T e, T f, T g, T h,
         T i, T j, T k, T l,
         T m, T n, T o, T p) { setTo(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p); }
  ...
  Mat4<T>::asMat4f() const
  {
    ...
    return Mat4<float>(static_cast<float>(a00), static_cast<float>(a01), static_cast<float>(a02), static_cast<float>(a03),
                       ...
                       static_cast<float>(a30), static_cast<float>(a31), static_cast<float>(a32), static_cast<float>(a33));
  }
  ...
  Mat4<T>::asMat4d() const
  {
    ...
    return Mat4<double>(static_cast<double>(a00), static_cast<double>(a01), static_cast<double>(a02), static_cast<double>(a03),
                        ...
                        static_cast<double>(a30), static_cast<double>(a31), static_cast<double>(a32), static_cast<double>(a33));
  }
